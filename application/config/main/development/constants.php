...
define('REDIS_DB', 0);
define('PACKAGE_PATH', APPPATH);
define('LANGUAGE_DEFAULT_FILE', 'cases');
define('LANGUAGE_DEFAULT_COOKIE', 'base_url_lang');
define('LOG_PATH', APPPATH.'/logs/log.txt');
define('LOG_PATH_DIRECTORY', PACKAGE_PATH.'/logs/');
define('APPLICATION_NEWS', 'news');
define('SITE_NAME', 'ci-test.loc');
